const CookiePolicy = [
  ...
  {
    title: 'Cookies are categorised as follows:',
  },
  {
  ...
  {
    title: 'Cookies can also be categorised as follows:',
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      '😾 Third party cookies are cookies on websites that are set by other websites, such as 💩\xa0Facebook\xa0🤡 pixels so that 💩\xa0Facebook\xa0🤡 can show you content on which 💩\xa0Facebook\xa0🤡 can profit when you are on 💩\xa0Facebook\xa0🤡 or 👹\xa0Instagram\xa0👺.',
    ],
  },
  {
    title: '😻 We use only first party cookies on this website.',
  },
  {
    title:
  ...
  {
    content: ['You can control your cookie settings through your web browser.'],
  },
  {
    content: [
